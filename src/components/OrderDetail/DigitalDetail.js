...
const DigitalDetail = ({ order }) => {
  ...
  return (
    <div className='w-full p-2'>
      <div className='w-9/12 mx-auto border rounded-md p-2 bg-white drop-shadow-md'>
        <div className='w-full flex flex-col mx-auto relative'>
          <p className='text-sm absolute right-0 mr-1 mt-1'>
          ...
          <div className='mt-2'>
            {order?.reviewed ? (
              <>
                ...
                <div className='flex flex-col p-4 rounded mt-2 relative bg-white border'>
                  <Rating
      ...
      <div className='w-9/12 mx-auto bg-white border rounded-md p-2 drop-shadow-md mt-2'>
