        ...
        >
          <div className='w-full p-2 relative'>
            ...
            <div className='w-full border-b-2 p-2'>
              ...
              <p className='text-gray-400 mt-2 font-medium text-md'>
                Heres a few simple steps to get your storefront up and running!
              </p>
            </div>
            <div className='p-2'>
              <div className='w-full flex items-center'>
                <h2 className='w-full mt-4 text-md'>
                  You can always find this help box by selecting{' '}
                  <span className='font-medium'>'Help'</span> in the navigation
                  menu
                </h2>
              </div>
              ...
              <p className='text-lg mt-4'>
                <span className='font-medium'>1.</span> Before your storefront
                can take any orders, you must connect to a payment gateway in{' '}
                <Link
                  to='/settings'
              ...
              <p className='mt-4 text-lg'>
                ...
                tab to add other content to your storefront like a logo,
                customer questions and social links
              </p>
              <p className='mt-4 text-lg'>
