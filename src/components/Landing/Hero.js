  ...
  return isMobile ? (
    <div className='flex flex-col w-11/12 text-center mt-20'>
      <div className='flex flex-col w-full'>
        ...
        <Link to='/signup' className='flex mt-8'>
          <button className='rounded text-stone-800 w-full h-10 text-xl mt-4 border-stone-800 border-2 hover:bg-stone-800 hover:text-white flex items-center justify-center'>
            Launch a page
          </button>
        </Link>
      </div>
    ...
    <div className='flex items-center justify-between h-screen w-8/12'>
      <div className='flex flex-col w-6/12'>
        <p className='text-5xl font-medium text-stone-800'>
          Bring your digital products to LIFE.
        </p>
        ...
        <p className='font-medium text-3xl text-stone-800 mt-8'>
          Keep <span className='bg-stone-800 rounded text-white p-1'>99%</span>{' '}
          of what you earn.
        </p>

        <Link to='/signup' className='flex mt-8'>
          <button className='rounded text-stone-800 w-96 h-10 text-xl mt-4 border-stone-800 border-2 hover:bg-stone-800 hover:text-white flex items-center justify-center'>
            Launch a page
          </button>
        </Link>
      </div>
