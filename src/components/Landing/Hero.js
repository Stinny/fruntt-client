...
const Hero = () => {
  ...
  return isMobile ? (
    <>
      <div className='flex flex-col w-11/12 text-center h-screen items-center justify-center'>
        <div className='flex flex-col w-full mt-20'>
          <p className='text-3xl text-center font-medium text-stone-800'>
            Most{' '}
            <span className='underline underline-offset-3'>affordable</span>{' '}
            option to sell digital products.
          </p>
          <p className='font-medium text-2xl text-stone-800 mt-8'>
            Keep{' '}
            <span className='bg-stone-800 rounded text-white p-1'>99%</span> of
            what you earn.
          </p>
      ...
      <div className='w-full h-4/6 mt-12 p-4'>
        <PageSamp />
      </div>
    </>
  ) : (
    <>
      ...
      <div
        className=' h-4/5 flex flex-col items-center'
        style={{ width: '625px' }}
      >
        <PageSamp />
      </div>
